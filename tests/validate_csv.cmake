...
execute_process(
  COMMAND "${BENCHMARK}"
    ...
    --curve-segments 4 --shapes 1 --no-gpu --no-images --csv "${CSV_PATH}"
...
set(expected_header
  "schema_version,timestamp_utc,hostname,os,cpu,cpu_logical_threads,compiler,build_type,api,gpu_vendor,gpu_renderer,gpu_version,gpu_hardware,subgroup_size,workgroup_size,width,height,aa_grid,curve_segments,shape_count,edge_count,requested_cpu_threads,cpu_threads_used,warmup,iterations,backend,timing_scope,median_ms,minimum_ms,p90_ms,megapixels_per_second,speedup_vs_scalar,differing_pixels,max_channel_error,mean_absolute_channel_error")
